...
import { Terminal, GraduationCap, Briefcase, ChevronDown, Lock, ShieldCheck, CreditCard, Scan } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 max-w-3xl mx-auto mb-12">
          ...
          <ScrollReveal delay={200}>
            ...
            >
              {/* Background Visual */}
              <div className="absolute inset-0 z-0 flex items-center justify-center opacity-[0.03] group-hover:opacity-[0.05] transition-opacity">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className={`w-16 h-16 rounded-full border bg-black/20 flex items-center justify-center mb-6 transition-all duration-500 ${selectedTrack === 'student' ? 'border-retro-cyan bg-retro-cyan/10' : 'border-white/10 group-hover:border-retro-cyan/50 group-hover:bg-retro-cyan/10'}`}>
                  <GraduationCap className={`w-8 h-8 transition-colors duration-500 ${selectedTrack === 'student' ? 'text-retro-cyan' : 'text-retro-text/40 group-hover:text-retro-cyan'}`} />
                </div>
