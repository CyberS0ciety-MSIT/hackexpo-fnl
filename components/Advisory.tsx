...
import { Shield, Linkedin, User } from 'lucide-react';
import { ADVISORY } from '../constants';
import { PopOutCard } from './PopOutCard';
import { ScrollReveal } from './ScrollReveal';

const Advisory: React.FC = () => {
    const renderAdvisoryCard = (member: typeof ADVISORY[0]) => {
        const CardContent = (
    ...
    return (
        <section id="advisory" className="py-32 bg-nothing-black relative overflow-hidden border-b border-nothing-border/30">
            {/* Background Ambience */}
                ...
                <ScrollReveal>
                    <div className="flex flex-col items-center mb-20 text-center">
                        <div className="flex items-center gap-3 mb-6">
                            <Shield className="w-6 h-6 text-retro-cyan animate-pulse" />
                            <span className="text-retro-cyan font-mono text-sm tracking-[0.4em] uppercase">Executive Guidance</span>
                        </div>
                        <h2 className="text-5xl md:text-6xl font-bold text-white font-sans tracking-tight mb-6">
                            ADVISORY <span className="text-retro-cyan shadow-retro-cyan">BOARD</span>
                        </h2>
